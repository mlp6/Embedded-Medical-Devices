...
* [GitHub CoPilot Chat](https://code.visualstudio.com/docs/copilot/overview) AI coding assistant (optional, but highly recommended)
...
::: callout-tip
Be sure to use the `nRF Connect SDK v3.2.1` for this class.  The starter code
