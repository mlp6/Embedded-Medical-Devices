...
- [Emily Song](mailto:emily.c.song@duke.edu)

- [Jack Rinaldi](mailto:jack.rinaldi@duke.edu)

- [Kaden Bock](mailto:kaden.bock@duke.edu)

- [Kerry Eller](mailto:kerry.eller@duke.edu)

TA office hours (in the lab), will be posted on the Canvas calendar.

::: callout-tip
Any questions related to code, data analysis, etc. should be asked as GitLab
Issues assigned to a TA and Dr. Palmeri.
:::
...
Monday & Wednesday, 08:30-09:45, Wilkinson 132 (Panopto recorded)

### Labs

Location: CIEMAS B209 (Door Code: TBA)
...
All assignment feedback will be posted to your GitLab repository and grades will
be posted to Canvas throughout the semester to track your performance.

| Grade Category   | Relative Percentage   |
|:----------------|:---------------------|
| Quizzes & Nordic DevAcademy Modules | 20% |
| Code Reviews | 15% |
| Lab Technical Reports | 25% |
| Final Device Code Review, Presentation & Report | 35% |
| Participation | 5% |
...
[GitHub CoPilot](https://github.com/features/copilot) (free to students through
the [GitHub Education](https://github.com/education/students) program), and
Codex/Claude Code.  These tools can be leveraged to help with syntax.  

::: callout-caution
You are strongly cautioned to not rely on these tools for logical
implementation, and they cannot be used during the in-person code reviews.  You
should not "blindly" feed the assignments into these tools to have them attempt
to perform all of the coding for you.  If Dr. Palmeri suspects that this has
occurred, he reserves the right to question you about your understanding of your
submission and will grade that submission based on that evaluation.
:::
