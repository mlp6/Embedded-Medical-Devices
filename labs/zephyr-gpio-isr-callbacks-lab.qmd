...
<!-- TODO: change this to the semester-specific Kits repo -->
1. Fork the [lab template repository](https://gitlab.oit.duke.edu/EmbeddedMedicalDevices/zephyr-gpio-isr-callbacks-lab) into your personal GitLab user space.
1. Add Dr. Palmeri (`mlp6`) as a `Maintainer` of your project ASAP.  This will allow him to add your TAs and some project labels.
1. Clone your forked project to your local laptop.

## Kernel Configuration

Take note of kernel configurations enabled in [prj.conf](prj.conf):
...
`nrf52833dk_nrf52833.overlay` and it is located in the `boards/` directory.
...
- Grading feedback will be given on code:
  - Functionality
