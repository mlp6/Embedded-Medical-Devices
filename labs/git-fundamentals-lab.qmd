...
1. Create a **fork** (:warning: not a clone :warning:) of this project.
1. Clone your forked (:warning: not the parent you forked from:warning:) repository to your laptop, which contains the default `README.md` file to your laptop.
