...
::: callout-tip
Be sure to add a DC offset of `VDD`/2 to your input signal so that the signal is
within the common-mode voltage range of the ADC.
:::
...
single `adc_read_dt()` call (i.e., you are not using a kernel call for every
sample).
