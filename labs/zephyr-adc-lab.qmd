...
- Add this analysis to a new section in `testing/testing_adc.ipynb`.
...
- Repeat the testing you performed in the syncronous section in a new section in
`testing/testing_adc.ipynb`.
...
Discuss the pros/cons of sampling a time-series of data using:

1. Syncronous Buffered Sampling

1. Asyncronous Buffered Sampling

1. Timers-Based Single Sampling
