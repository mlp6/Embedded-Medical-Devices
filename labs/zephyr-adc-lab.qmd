...
- Utilize the 3 Zephyr enumerations presented in lecture to modulate the
...
- Optional functionality: 
    ...
    - Implement a timeout mechanism to handle the case where the ADC sequence
    does not complete within a reasonable time frame.
