...
- The return code for `adc_read_async()` is immediate and indicates whether the
ADC sequence was started successfully.  (It is not the returned enumerations
from the callback function described on the next slide.)
