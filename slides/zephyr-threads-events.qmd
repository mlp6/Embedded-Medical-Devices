...
```mermaid
sequenceDiagram
    participant ISR as Button ISR<br/>Callback
    participant KEvents as Kernel Event<br/>Bit Array
    participant Worker as Worker Thread

    Worker->>KEvents: k_event_wait()<br/>[blocking]
    activate Worker
    ...
    Worker->>Worker: process event<br/>(e.g., change state)
```
