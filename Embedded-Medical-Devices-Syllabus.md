...
| [C Programming](https://gitlab.oit.duke.edu/EmbeddedMedicalDevices/c-programming) | Available on Canvas| [C Programming Lab](https://gitlab.oit.duke.edu/EmbeddedMedicalDevices/c-programming-lab/-/blob/main/README.md?ref_type=heads)|
